 ...
 * header, validates it via UserApiTokenService, and populates the
 * SecurityContext.
 *
 * <p>
 * If the header is present but the key is invalid, immediately responds
 * with 401 via {@link RestAuthEntryPoint}.
 * </p>
 */
@Component
