...
public class JwtUtil {
    ...
    private static final String DEV_JWT_SECRET = "Z2FzaS1kZXYtand0LXNlY3JldC1jaGFuZ2UtbWUtYmVmb3JlLXByb2Q=";
     ...
     */
    public JwtUtil(
            @Value("${auth.jwt.secret:" + DEV_JWT_SECRET + "}") String secret,
    ...
    /**
     * Get the JWT ID from a refresh token after verifying its token type.
     */
