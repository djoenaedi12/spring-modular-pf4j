...
public class AppClientEntity extends BaseEntity {
    ...
    @Column(name = "max_failed_login_attempts", nullable = false, columnDefinition = "INTEGER DEFAULT 5")
    private Integer maxFailedLoginAttempts;

    @Column(name = "lockout_seconds", nullable = false, columnDefinition = "INTEGER DEFAULT 900")
